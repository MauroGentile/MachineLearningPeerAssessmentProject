...
As a result, it will be shown that Random Forest and C5 are the best performing alghorithms, both reaching a 99,4% accuracy.
...
Random Forest and C5 with an accuracy of 99,4% and a very narrow confidence interval (0.4% wide).
...
We have seen that while Random Forest and C5 are the best model on this data set and virtually indistinguishable each other, C5 is much better than Random Forest since it reaches the same results in a much shorter time. C5 is therefore chosen as preferred model on this data set.
